...
timeout /t 1
START "" "C:\Program Files\obs-studio\bin\64bit\obs64.exe" --profile "presentation-live" --collection "1lang-presentation" --scene "Landing" -m --disable-updater
timeout /t 1
START "" "C:\Program Files\obs-studio\bin\64bit\obs64.exe" --profile "presentation-rec" --collection "1lang-presentation" --scene "Landing" -m --disable-updater
timeout /t 1
